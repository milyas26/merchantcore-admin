...
export const productAttributeFormSchema = z.object({
  name: z.string().min(1, "Nama atribut wajib diisi").max(100, "Nama atribut maksimal 100 karakter"),
  value: z.string().min(1, "Nilai atribut wajib diisi").max(500, "Nilai atribut maksimal 500 karakter"),
  position: z.number().int().nonnegative().optional().default(0),
});
